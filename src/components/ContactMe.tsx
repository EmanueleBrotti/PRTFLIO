...
export default function ContactMe(props:{mouseV:Function}) {
    return(
        <div className="bg-dark text-light p-4 h-[calc(100vh-2*var(--navHeight))] min-h-fit">
            <Reveal>
                <h2 className="text-3xl xsm:text-4xl sm:text-5xl md:text-6xl font-bold mt-5 transition-all duration-500 pb-8 w-fit" onMouseEnter={() => props.mouseV("text")} onMouseLeave={() => props.mouseV("default")}>LET'S RENDEZVOUS:</h2>
            </Reveal>
