...
export default function SkillBlock(props: {name: string,icon: string, link: string, onHover: Function}) {

    return (
        <a href={props.link} target="_blank" rel="noreferrer" onMouseEnter={() => props.onHover(props.name)}>
