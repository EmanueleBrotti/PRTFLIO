...
export default function Projects(props:{mouseV:Function}) {
    return (<>
                ...
                <Reveal>
                <h2 className="text-3xl xsm:text-4xl sm:text-5xl md:text-6xl text-wrap xsm:text-nowrap transition-all duration-500 font-bold mt-5 m-0 w-fit cursor-none" onMouseEnter={() => props.mouseV("title")} onMouseLeave={() => props.mouseV("default")}>
