...
function App() {
  ...
  return (
    <>
      ...
      <div className="w-100 h-fit flex flex-col p-4 bg-light text-dark mb-5">
      ...
      <div className="w-100 h-fit bg-dark text-light p-4 grid grid-flow-row grid-cols-1 sm:grid-cols-2 gap-4">
        {/*portfolio elements*/}
